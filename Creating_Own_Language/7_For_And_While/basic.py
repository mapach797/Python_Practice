...
KEYWORDS = [
    ...
    'OR', 
    'NOT',
    # adding tokens for if statement
    'IF',
    'THEN', 
    'ELIF',
    'ELSE',
    # adding tokens for 'FOR' and 'WHILE'
    'FOR',
    'TO',
    'STEP',
    'WHILE'
...
class Token:
    ...
    # __repr__ is a special method used to represent a class' object as a string
    def __repr__(self):
...
class Lexer:
    ...
    #will advance to next character in the text
    def advance(self):
        self.pos.advance(self.current_char)              # goes to next position
